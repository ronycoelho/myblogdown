...
Now, I will show you an imgage of the dictionary of Munics-IPs presenting its first lines

![Sample: dictionary - Munic-IPs](C:/myblogdown/static/dic_munic_.png)

You can find the complete version of the dicitonary in the of my github above

#

Now it's time to view the database itself. I will show only the first 100 variables and the first 300 observations. The full version has 5,570 rows (number of municipalities) and more than 1,000 columns.

```{r}
base_munic %>% 
  select(1:107) %>% 
  head(300) %>% 
  knitr::kable(table.attr='class="table-fixed-header"') %>% 
...
![Sample: dictionary - Estadics-IPs](C:/myblogdown/static/dic_est_.png)
